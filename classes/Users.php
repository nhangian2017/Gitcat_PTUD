...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(empty($id)){
			$qry = $this->conn->query("INSERT INTO userss set {$data}");
			if($qry){
			...
			$qry = $this->conn->query("UPDATE userss set $data where id = {$id}");
			if($qry){
				...
				return "UPDATE userss set $data where id = {$id}";
			}
	...
	public function delete_users(){
		extract($_POST);
		$qry = $this->conn->query("DELETE FROM userss where id = $id");
		if($qry){
