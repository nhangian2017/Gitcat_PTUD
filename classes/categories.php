...
class categories
{
    ...
    public function getAllAdmin($page = 1, $total = 8)
    {
        ...
        $tmp = ($page - 1) * $total;
        $query = "SELECT * FROM categories order by name asc limit $tmp,$total";
    ...
    public function update($data)
    {
        ...
        if ($result) {
			return '<script type="text/javascript">alert("Cập nhật thành công!"); window.location.href = "categoriesList.php";</script>';
        } else {
