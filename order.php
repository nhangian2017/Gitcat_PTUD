...
<nav class="menu">
    ...
    <center><h2 style="background: #effbf8; margin-top: 10px;">Đơn hàng của <?= $userInfo['fullname'] ?> </h2></center >
    </div>
            ...
            <table class="order">
                ...
                foreach ($result as $key => $value) { ?>
                    <tr>
                        ...
                        <td><?= ($value['status'] != "Đang xử lý") ? $value['receivedDate'] : "Dự kiến 3 ngày sau khi đơn hàng được xử lý" ?> <?=  
                        ($value['status'] != "Hoàn thành" && $value['status'] != "Đang xử lý") ? "(Dự kiến    )" : "" ?> </td>
                        <?php
                        if ($value['status'] == 'Đang giao hàng') { ?>
                            <td>
                                <a href="complete_order.php?orderId=<?= $value['id'] ?>">Đang giao (Click vào để xác nhận đã nhận hàng)</a>
                            </td>
                            <td>
